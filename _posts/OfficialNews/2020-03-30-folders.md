...
<br>
我們的許多用戶都依賴 Telegram 進行**工作**和**學習**，在過去幾週更是如此。為了確保每個人的聊天列表都可以處理增加的負擔，並且您也不會錯過任何重要的訊息，我們今天引進了可以自訂的「聊天室分類」功能。
...
<br>
您可以包含或排除特定類型的所有聊天，例如「頻道」、「未讀」或「私聊」。

當您的聊天列表長得讓您有一點混亂時，聊天室分類的功能就變得很實用。您可以點擊<a href="tg://settings/folders">此連結</a>來開啟程式中的「聊天室分類」的設定頁面。
