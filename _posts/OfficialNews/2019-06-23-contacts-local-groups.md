...
<center><img alt="" src="{{ site.baseurl | prepend: site.url }}/images/contacts-local-groups02.jpeg" width="80%"></center>
<br>
...
<center><img alt="" src="{{ site.baseurl | prepend: site.url }}/images/contacts-local-groups06.jpeg" width="80%"></center>
<br>
傳遞火炬是一件容易的事，只需輕按兩下即可。

### 增強的通知例外

通知例外變得更加強大。現在，您可以為特定的聊天切換**訊息預覽**。如果您有很多例外情況，請使用**搜尋**找到正確的聊天室，或使用**全部刪除**立即回到一致的設定。

<center><img alt="" src="{{ site.baseurl | prepend: site.url }}/images/contacts-local-groups07.jpeg" width="80%"></center>
<br>
