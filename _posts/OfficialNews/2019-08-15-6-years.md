...
<img alt="" src="{{ site.baseurl | prepend: site.url }}/images/6-years07.jpeg" alt="🥳" height="20" width="20">隨著動態貼圖的成功，此更新還為<img alt="" src="{{ site.baseurl | prepend: site.url }}/images/6-years03.jpeg" alt="❤️" height="20" width="20">、<img alt="" src="{{ site.baseurl | prepend: site.url }}/images/6-years04.jpeg" alt="👍" height="20" width="20">、<img alt="" src="{{ site.baseurl | prepend: site.url }}/images/6-years05.jpeg" alt="😒" height="20" width="20">、<img alt="" src="{{ site.baseurl | prepend: site.url }}/images/6-years06.jpeg" alt="😳" height="20" width="20">和引入了動態表情符號。之後預計會有更多。
