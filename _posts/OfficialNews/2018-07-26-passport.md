...
<center><img alt="" src="{{ site.baseurl | prepend: site.url }}/images/passport02.gif"></center>
### 受端到端加密保護
您的身分證件和個人資料將使用端到端加密儲存在 Telegram 雲端中。它使用只有您知道的密碼加密，因此 Telegram 無法存取您儲存在 Telegram Passport 中的資料。當您分享資料時，它會直接轉到接收的一方。

<center><img alt="" src="{{ site.baseurl | prepend: site.url }}/images/passport03.jpeg" width="80%"></center>
