...
<br>
如果您使用<a href="https://telegram.how/2020/03/30/folders">聊天室分類</a>（就是"資料夾"）或封存的聊天來組織聊天列表，應用程式將遵循您設置的結構：目前分類中的頻道、然後是其他分類中的頻道、最後是留在未分類聊天和封存中的未讀頻道。只要從您的某個聊天室分類中開啟一個頻道即可閱讀所有內容，而不會分心 — 反之亦然。
