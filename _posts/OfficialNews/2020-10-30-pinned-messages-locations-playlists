...
<br>
萬聖節到了，我們正在引入新功能來幫助您安排搗蛋的活動。在每個聊天中使用多個置頂訊息來練習您神奇的巫毒技能，使用 Live Locations 2.0 監視街上的其他殭屍，以及將讓人提心吊膽的音樂放入播放列表等。

如果您想簡易地閱讀本次更新，而無需大多數萬聖節的內容，請嘗試此頁面。

### 多個置頂訊息
置頂訊息很像炸馬鈴薯片，很難只有吃一片，這就是為什麼現在您可以在任何聊天中置頂多則訊息的原因。點擊頂部的欄可以在它們之間跳轉 – 如果要在單獨的頁面上查看它們全部，請使用右側的新按鈕（圖釘按鈕）。

<center><img alt="" src="{{ site.baseurl | prepend: site.url }}/images/pinned-messages-locations-playlists02.gif" width="70%"></center>
<br>
除了頻道和群組外，置頂訊息現在可以在一對一的聊天中使用，可用於許多方面，從購物清單到友善的賭注或是其他內容。

### 改善即時位置 ( Live Locations )
當朋友分享他們的即時位置時，您可以設定一個警報器，當他們關閉時會通知您。現在，即時位置圖上的圖示還顯示了他們面對的方向。
...
### 播放列表
當您同時傳送多首歌曲時，它們會被排列在一個播放列表中 - 更容易播放、轉傳或評論。打開其中一首歌曲會將它們全部排入 Telegram 的內建媒體播放器中。
...
### 頻道貼文統計
留言功能增加了頻道中訂閱者的活動，現在我們為管理員引入了新工具來追踪它。除了頻道統計資料之外，您還可以查看頻道中各個貼文的統計 - 包括將貼文轉傳到公開頻道的一個列表。

<center><img alt="" src="{{ site.baseurl | prepend: site.url }}/images/pinned-messages-locations-playlists05.jpeg" width="70%"></center>
<br>
### Android 上流暢的新動態效果
同時，我們的 Android 科學怪人不斷加入新的動態效果，這次則是應用於傳送訊息以及音樂播放器中的切換歌曲。

<center><img alt="" src="{{ site.baseurl | prepend: site.url }}/images/pinned-messages-locations-playlists06.gif" width="70%"></center>
<br>
同樣在 Android 上：檢視收到的照片時，您可以立即編輯並傳送回去，而無需下載和上傳。檢視照片時，只需輕按畫筆按鈕即可快速用X標記一個點，或在臉上貼上骷髏貼圖。
...
<br>
即使您不探究<img alt="" src="{{ site.baseurl | prepend: site.url }}/images/pinned-messages-locations-playlists11.png" alt="🗿" height="20" width="20">萬聖節的所有炒作，我們也會以動畫形式淹沒您：

<center><img alt="" src="{{ site.baseurl | prepend: site.url }}/images/pinned-messages-locations-playlists09.gif" width="70%"></center>
<br>
### 如何獲得此更新
具有這些功能的新版本已經可以透過 Google Play 或 APK 供我們所有的 Android 用戶使用。如果您使用的是 iOS ，則只要a）蘋果完成對它的審查，或b）您決定是時候切換到 Android 了，那麼您就會得到更新。👀 更新：（10月31日）此更新的 iOS 部分現已獲得批准。

現在，我們將專注於服裝的準備上。我們將成為過去群聊的幽靈：256 個成員，沒有審核工具，完全被綠色的粘液覆蓋。那麼我們在另外一邊見！
