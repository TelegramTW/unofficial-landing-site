...
目前，投票是**匿名的**，這意味著沒有人能夠看到誰投了什麼票。展望未來，我們可能會引進非匿名投票，其中選民清單將會是公開的，但此類投票活動將明確標示為非匿名。
...
繼續大規模地找出 iOS 版錯誤，應用程式在 **5.1.1** 版本中收到了大量修正。

舉幾個改善的例子：在*設定* > *數據和儲存* > *儲存空間用量*中，清除快取的功能現在可以正確地**減少**應用程式佔用的**空間**。關閉應用程式後，檔案和媒體將**繼續下載**一段時間。下載和上傳檔案時，您將看到**詳細的進度**。我們還在搜尋結果中加入了人們的**在線上指標**。
